...
This frustrating phenomenon is called **mode collapse**. Past research blamed the AI's post-training process (e.g., RLHF), assuming the algorithms naturally favored the most common, "safe" answer. **We discovered something more fundamental**: The problem isn't just the AI. It's us.

## 2. Intuition

Aligned LLMs collapse to stereotypical outputs due to [**typicality bias**](https://arxiv.org/abs/2501.14860) in human preferences. VS asks for a small distribution (k items + probabilities) to recover diversity without training.
...
### 3.3 Distribution‑level recovery (VS)
...
## 4. Interactive Explainer: Typicality Bias
...
<Figure id="diversity-gains" caption="Creative writing diversity improvements with VS (poem, story, joke); VS‑CoT achieves 1.6–2.1× gains [@zhang2025vs, Figure 3a–c].">
  ...
  <img src="public/images/creative_writing.png" alt="Creative writing diversity improvements" style="border: none; box-shadow: none;" />
</Figure>

<div className="figure-grid">

#### Post-Training Diversity Loss
...
<Figure id="post-training" caption="Diversity retention across training stages; VS recovers to 66.8% of base diversity [@zhang2025vs, Figure 4].">
  ...
  <img src="public/images/training_progression.png" alt="Diversity retention across training stages" style="border: none; box-shadow: none;" />
</Figure>
...
<Figure id="pareto-frontier" caption="VS is orthogonal to temperature; combining the two improves the diversity–quality frontier [@zhang2025vs, Figure 5].">
  <img src="public/images/pareto-frontier.png" alt="VS is orthogonal to temperature; combining the two improves the diversity–quality frontier" style="border: none; box-shadow: none;" />
</Figure>

</div>

#### Emergent Scaling Benefits
...
<Figure id="scaling-trend" caption="Larger models benefit ~1.5–2× more from VS [@zhang2025vs, Figure 3e–f].">
  <img src="public/images/emergent_behavior.png" alt="Larger models benefit ~1.5–2× more from VS" style="border: none; box-shadow: none;" />
</Figure>

#### Temperature Ablation Study

Systematic temperature variations confirm VS maintains effectiveness across the full temperature range, with optimal results when both techniques are combined [@zhang2025vs, Figure 5].
...
<Figure id="temperature-ablation" caption="VS is orthogonal to temperature; combining the two improves the diversity–quality frontier [@zhang2025vs, Figure 5].">
  <img src="public/images/temperature_scaling.png" alt="VS is orthogonal to temperature; combining the two improves the diversity–quality frontier" style="border: none; box-shadow: none;" />
</Figure>
...
<Figure id="intuitive-demo" caption="Intuitive demo of VS [@zhang2025vs, Figure 6a].">
  <img src="public/images/qualitative_example.png" alt="Intuitive demo of VS" style="border: none; box-shadow: none;" />
</Figure>
...
<a id="variants" />
## 10. VS Variants: When to Use Which
...
### 11.1 From "Once Upon a Time" to Bernard the Tax Accountant Bear
