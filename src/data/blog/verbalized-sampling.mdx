...
description: "Interactive blog showcasing Verbalized Sampling—a training-free method that restores diversity in aligned LLMs by 1.6-2.1× by asking for probability distributions instead of single answers. Explore results, examples, and try it yourself."
...
ogImage: "/images/qualitative_example.png"
...
<Figure id="diversity-gains" caption="Creative writing diversity improvements with VS (poem, story, joke); VS‑CoT achieves 1.6–2.1× gains.">
  {/* <DiversityGainsVisual client:visible /> */}
  <img src="/images/creatitive_main.png" alt="Creative writing diversity improvements" style="border: none; box-shadow: none;" />
</Figure>
...
<div className="content-grid">
  <div className="text-content">
    VS can mitigate mode collapse and maintain higher diversity scores across different post-training stages.
  </div>
    <div className="figure-content">
    <Figure id="temperature-ablation" caption="VS is orthogonal to temperature; combining the two improves the diversity–quality frontier.">
      <img src="/images/training_progression.png" alt="VS is orthogonal to temperature; combining the two improves the diversity–quality frontier" style="border: none; box-shadow: none; max-width: 100%; height: auto;" />
    </Figure>
  </div>
</div>
