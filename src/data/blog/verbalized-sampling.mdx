...
<Figure id="post-training" caption="Diversity retention across training stages; VS recovers to 66.8% of base diversity [@zhang2025vs, Figure 4].">
  ...
  <img src="/vs-blog-temp/images/training_progression.png" alt="Diversity retention across training stages" style="border: none; box-shadow: none;" />
</Figure>
...
<Figure id="pareto-frontier" caption="VS is orthogonal to temperature; combining the two improves the diversity–quality frontier [@zhang2025vs, Figure 5].">
  <img src="/vs-blog-temp/images/pareto-frontier.png" alt="VS is orthogonal to temperature; combining the two improves the diversity–quality frontier" style="border: none; box-shadow: none;" />
</Figure>
