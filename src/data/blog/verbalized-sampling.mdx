...
### 2.4 Embrace Mode Collapse: Distribution-Level Recover Diversity
...
<div className="content-grid">
  ...
  <div className="figure-content">
    <Figure id="post-training" caption="Diversity retention across training stages; VS recovers to 66.8% of base diversity [@zhang2025vs, Figure 4].">
      ...
      <img src="/images/training_progression.png" alt="Diversity retention across training stages" style="border: none; box-shadow: none; max-width: 80%; height: auto;" />
    </Figure>
  </div>
</div>
